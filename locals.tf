locals {
    ...
    lambda_function_api_gateway_invoke_url = var.lambda_function_enable && var.lambda_function_api_gateway ? "${aws_api_gateway_deployment.lambda_api_gateway_deployment[0].invoke_url}/${var.name}" : null
